...
I'ᴍ ʏᴏᴜʀ Mᴏᴠɪᴇ, Sᴇʀɪᴇs, ᴀɴᴅ Aɴɪᴍᴇ ᴇxᴘᴇʀᴛ! Jᴜsᴛ ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴀs ᴀɴ ᴀᴅᴍɪɴ, ᴀɴᴅ ʏᴏᴜ ᴄᴀɴ ᴇɴᴊᴏʏ ᴀʟʟ ᴛʜᴇ ᴄᴏɴᴛᴇɴᴛ ʏᴏᴜ ᴡᴀɴᴛ!

ᴍᴀɴᴛᴀɪɴᴇᴅ ʙʏ : <a href="https://t.me/plexamovies">𓆩P L E X A𓆪</a></b>"""
...
ᴍʏ ᴏᴡɴᴇʀ - <a href="https://t.me/plexamovies">𓆩P L E X A𓆪</a></b>"""

    ABOUT_TXT = """<b>
 🤖 ᴍʏ ɴᴀᴍᴇ : {}
 👨‍💻 ᴄʀᴇᴀᴛᴏʀ : <a href='https://t.me/VINEET346'>𓆩𝐕 𝖎 𝐧 𝖊 𝖊 𝐭𓆪</a>
 ...
 🥶 ʙᴜɪʟᴅ sᴛᴀᴛᴜs : ᴠ3.0 [sᴛᴀʙʟᴇ​]</b>"""
    ...
    SOURCE_TXT = """<b>ɴᴏᴛᴇ:
🤖 ᴛʜɪs ʙᴏᴛ ɪs ᴀ ᴘʀɪᴠᴀᴛᴇ ᴘʀᴏᴊᴇᴄᴛ.
Fᴏʀ Qᴜᴇʀɪᴇs:
👨🏻‍💻 <a href="https://t.me/plexasupport_bot">Sᴜᴘᴘᴏʀᴛ</a></b>
...
<b>ᴜʀʟ ʙᴜᴛᴛᴏɴꜱ:</b>
<code>[Button Text](buttonurl:https://t.me/plexamovies)</code>
<b>ᴀʟᴇʀᴛ ʙᴜᴛᴛᴏɴꜱ:</b>
...
›› sᴛᴇᴘ 1 : ғɪʀsᴛ ʏᴏᴜ ʜᴀᴠᴇ ᴛᴏ ᴀᴅᴅ ᴛʜɪs ʙᴏᴛ ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴡɪᴛʜ ᴀᴅᴍɪɴ ᴘʀɪᴠɪʟᴇɢᴇᴅ.
...
➥ ᴅᴏɴ'ᴛ ᴡᴀɪᴛ ᴀɴy ʟᴏɴɢᴇʀ ᴛᴏ ꜱᴛᴀʀᴛ ᴇᴀʀɴɪɴɢ ᴍᴏɴᴇy ꜰʀᴏᴍ yᴏᴜʀ ᴛᴇʟᴇɢʀᴀᴍ ɢʀᴏᴜᴩ. ᴀᴅᴅ ᴏᴜʀ ʙᴏᴛ ᴛᴏᴅᴀy ᴀɴᴅ ꜱᴛᴀʀᴛ ᴍᴀᴋɪɴɢ ᴍᴏɴᴇy 💰!
    ...
    EARN_TXT = """<b>
 Wᴇʟᴄᴏᴍᴇ ᴛᴏ Plexa | OTT & Movies❣

 Jᴏɪɴ ᴏᴜʀ ᴄʜᴀɴɴᴇʟꜱ

🔰<a href='https://t.me/plexamovies'>✥ ▷ P L E X A ◁</a>

🔰<a href='https://t.me/+wQ6XMvJIhQZmYmI1'>✥ ▷ Movies Group ◁</a>

🔰<a href='https://t.me/plexasupport'>✥ ▷ Back Up Channel ◁</a>
"""
    DISC_TXT = """
<b><code>
...
Pʟᴇᴀsᴇ ᴄᴏɴᴛᴀᴄᴛ ᴜs ɪғ ʏᴏᴜ ʜᴀᴠᴇ ᴀɴʏ ᴏ̨ᴜᴇsᴛɪᴏɴs: <a href="https://t.me/plexasupport_bot">𓆩S U P P O R T𓆪</a></b>"""
...
நகல் எழுதப்பட்டால், கோப்பு 05 நிமிடங்களில் நீக்கப்படும்"""
    ...
    NOR_TXT = """<b>
📟ᴛɪᴛʟᴇ : <code>{}</code>
👩🏻‍💻ʀᴇǫᴜᴇsᴛᴇᴅ ʙʏ : <code>{}</code>
📂ᴛᴏᴛᴀʟ ꜰɪʟᴇs ꜰᴏᴜɴᴅᴇᴅ : <code>{}</code>
...
⚠️ ᴛʜɪs ᴍᴇssᴀɢᴇ ᴡɪʟʟ ʙᴇ ᴀᴜᴛᴏ ᴅᴇʟᴇᴛᴇᴅ ᴀғᴛᴇʀ 𝟷𝟶 ᴍɪɴᴜᴛᴇs.</b>"""
...
𝖤𝗑𝖺𝗆𝗉𝗅𝖾 :- /country India</b>"""
    ...
    IMDB_TEMPLATE_TXT = """
<b>Hᴇʏ {message.from_user.mention}, Hᴇʀᴇ ɪs ᴛʜᴇ ʀᴇsᴜʟᴛ ғᴏʀ ʏᴏᴜʀ Qᴜᴇʀʏ {query}
...
<b>Hᴇʏ  {title} Mᴏᴠɪᴇ Aᴅᴅᴇᴅ ᴛᴏ Tʜɪs Gʀᴏᴜᴘ...

<i>{title}</i>
Pᴏᴡᴇʀᴇᴅ Bʏ  <a href="https://t.me/plexamovies">𓆩P L E X A𓆪</a></b>"""
...
⚠️ <b>Tʜɪs ғɪʟᴇ ᴡɪʟʟ ʙᴇ ᴅᴇʟᴇᴛᴇᴅ ғʀᴏᴍ ʜᴇʀᴇ ᴡɪᴛʜɪɴ 3 ᴍɪɴᴜᴛᴇs ᴀs ɪᴛ ʜᴀs Cᴏᴘʏʀɪɢʜᴛ©... !!!</b> \n\n
...
⚙️ ғɪʟᴇ sɪᴢᴇ : <code>{file_size}</code>
