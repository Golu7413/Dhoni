...
async def save_group(bot, message):
    ...
    if temp.ME in r_j_check:
        ...
        buttons = [[
                    ...
                    InlineKeyboardButton('Uᴘᴅᴀᴛᴇs', url='https://t.me/plexamovies'),
            ...
            for u in message.new_chat_members:
                ...
                temp.MELCOW['welcome'] = await message.reply_video(
                                                 ...
                                                 reply_markup=InlineKeyboardMarkup(
                                                                         [[
                                                                             InlineKeyboardButton('⚡sᴜᴘᴘᴏʀᴛ ᴄʜᴀᴛ⚡', url='https://t.me/plexasupport'),
                                                                             InlineKeyboardButton('⚡CHANNEL⚡', url='https://t.me/plexamovies')
                                                                        ]]
                                                 ),
